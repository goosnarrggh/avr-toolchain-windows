...
RUN C:\msys64\usr\bin\bash.exe -lc "pacman -Q mingw-w64-x86_64-avr-binutils mingw-w64-x86_64-avr-gcc mingw-w64-x86_64-avr-libc mingw-w64-x86_64-cmake mingw-w64-x86_64-ninja make mingw-w64-x86_64-srecord > /toolchain_metadata.txt"; Get-Content C:\msys64\toolchain_metadata.txt
